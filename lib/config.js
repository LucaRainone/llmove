...
function loadConfig() {
  ...
  if (fs.existsSync(CONFIG_FILE)) {
    try {
      ...
      return {
        ...
        model: envConfig.model || fileConfig.model || 'claude-opus-4-20250514',
        specsFolder: envConfig.specsFolder || fileConfig.specsFolder || 'specs'
      };
    } catch (error) {
  ...
  if (envConfig.apiKey) {
    return {
      ...
      model: envConfig.model || 'claude-opus-4-20250514',
      specsFolder: 'specs'
    };
  }
